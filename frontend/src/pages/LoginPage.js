...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-gray-50 p-4" data-testid="login-page">
        ...
        <div className="bg-white rounded-3xl border border-gray-100 shadow-soft p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-2">
              ...
              <Input
                id="email" type="email" placeholder="demo@dhandraft.com"
          ...
          <p className="text-center text-sm text-gray-500 mt-6">
            New here?{' '}
            <Link to="/register" className="text-dhan-blue font-medium hover:underline" data-testid="go-to-register">Create account</Link>
          </p>

          <div className="mt-4 p-3 bg-blue-50/60 rounded-xl border border-blue-100/60">
            <p className="text-xs text-blue-600 font-medium">Demo: demo@dhandraft.com / Demo123!</p>
          </div>
        </div>
      </div>
    </div>
